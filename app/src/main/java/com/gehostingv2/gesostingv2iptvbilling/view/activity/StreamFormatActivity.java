...
public class StreamFormatActivity extends AppCompatActivity implements ClientDetailInterface,
...
//                setupDrawerContent(navView);
    ...
    private void setHeaderFont() {
        ...
        tvSettings.setTypeface(fontOPenSansBold);
    }
...
//            EPGTimeShiftActivity activity = this;
...
//                loadFragment(selectedItem);
    ...
    private void callSettings() {
        ...
        if(allowedFormat.equals("m3u8")){
            rbM3u8.setChecked(true);
        }else if(allowedFormat.equals("ts")){
    ...
    public void onViewClicked(View view) {
        switch (view.getId()){
            case R.id.bt_save_changes:
                ...
                loginPrefsEditor = loginPreferencesSharedPref.edit();
                if (loginPrefsEditor != null) {
                    if(selectedPlayer.getText().toString().equals(getResources().getString(R.string.hls_m3u8))){
                        loginPrefsEditor.putString(AppConst.LOGIN_PREF_ALLOWED_FORMAT, "m3u8");
                    }else if(selectedPlayer.getText().toString().equals(getResources().getString(R.string.mpegts_ts))){
                        loginPrefsEditor.putString(AppConst.LOGIN_PREF_ALLOWED_FORMAT, "ts");
                    }
