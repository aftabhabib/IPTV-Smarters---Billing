 ...
 * Use the {@link InvoicesUnpaidFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class InvoicesUnpaidFragment extends Fragment implements InvoicesInterface {
     ...
     * @return A new instance of fragment InvoicesUnpaidFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static InvoicesUnpaidFragment newInstance(String param1, String param2) {
        InvoicesUnpaidFragment fragment = new InvoicesUnpaidFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_invoices_paid, container, false); //fragment_invoices_unpaid
    ...
    public void getInvoices(GetInvoicesCallback getInvoicesCallback) {
        if (getInvoicesCallback != null) {
            ...
            ArrayList<InvoicesDetailPojo> unbPaidInvoicesList = new ArrayList<InvoicesDetailPojo>();
            for (InvoicesDetailPojo invoicesDetailPojo : invoicesDetailPojoArrayList) {
                String status = invoicesDetailPojo.getStatus();
                if (status.equals("Unpaid"))
                    unbPaidInvoicesList.add(invoicesDetailPojo);
            }
            if (unbPaidInvoicesList.size() > 0) {
                if (myRecyclerView != null && emptyView != null) {
                    myRecyclerView.setVisibility(View.VISIBLE);
                    emptyView.setVisibility(View.GONE);
                    mAdapter = new InvoicesAdaper(unbPaidInvoicesList, getContext(), dashboardActivity, fontOPenSansBold);
                    myRecyclerView.setAdapter(mAdapter);
                }
            } else if (unbPaidInvoicesList.isEmpty()) {
                if (myRecyclerView != null && emptyView != null) {
                    myRecyclerView.setVisibility(View.GONE);
                    emptyView.setVisibility(View.VISIBLE);
                    if (context != null)
                        emptyView.setText(context.getResources().getString(R.string.no_unpaid_invoices));
                }
            }
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_search:
                ...
                if(context!=null)
                    searchView.setQueryHint(context.getResources().getString(R.string.search_unpaid_invoices));
