 ...
 * {@link TerminatedServicesFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link TerminatedServicesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TerminatedServicesFragment extends Fragment implements ServicesInterface {
    ...
    public TerminatedServicesFragment() {
     ...
     * @return A new instance of fragment TerminatedServicesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TerminatedServicesFragment newInstance(String param1, String param2) {
        TerminatedServicesFragment fragment = new TerminatedServicesFragment();
    ...
    public void getMyServices(GetClientProductsCallback getClientProductsCallback) {
        if (getClientProductsCallback != null) {
            ...
            ArrayList<ProductDetailPojo> terminatedServiceArrayList = new ArrayList<ProductDetailPojo>();
            for (ProductDetailPojo productDetailPojo : productDeailArrayList) {
                String status = productDetailPojo.getStatus();
                if (status.equals("Terminated"))
                    terminatedServiceArrayList.add(productDetailPojo);
            }
            if (terminatedServiceArrayList.size() > 0) {
                myRecyclerView.setVisibility(View.VISIBLE);
                emptyView.setVisibility(View.GONE);
                mAdapter = new ServicesAdapter(terminatedServiceArrayList, getContext(), dashboardActivity);
                myRecyclerView.setAdapter(mAdapter);
            } else if (terminatedServiceArrayList.isEmpty()) {
                if (myRecyclerView != null && emptyView != null) {
                    myRecyclerView.setVisibility(View.GONE);
                    emptyView.setVisibility(View.VISIBLE);
                    if (context != null)
                        emptyView.setText(context.getResources().getString(R.string.no_terminated_services));
                }
            }
        }
    }
