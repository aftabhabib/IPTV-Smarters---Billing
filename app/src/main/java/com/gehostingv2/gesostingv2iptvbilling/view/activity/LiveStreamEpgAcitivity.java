...
import com.gehostingv2.gesostingv2iptvbilling.presenter.LiveStreamsEpgPresenter;
import com.gehostingv2.gesostingv2iptvbilling.view.adapter.ExpandndableListAdapter;
import com.gehostingv2.gesostingv2iptvbilling.view.adapter.LiveStreamsEPGCategoriesAdapter;
...
public class LiveStreamEpgAcitivity extends AppCompatActivity implements
    ...
    public LiveStreamsEpgPresenter liveStreamsEpgPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_stream_epg_acitivity);
...
//        billingList.add("MY CREDITS");
    ...
    private void toolbarSet() {
        ...
        logoHomeIV = (TextView) toolbar.findViewById(R.id.tv_header_title);
//        if (logoHomeIV != null)
...
//        liveStreamsEpgPresenter = new LiveStreamsEpgPresenter(LiveStreamEpgAcitivity.this, context);
        ...
        if (context != null) {
            ...
            if (parentalStatusCount > 0 && liveListDetail != null) {
                ...
                liveListDetailUnlckedDetail = getUnlockedCategories(liveListDetail,
                        listPassword);
                liveListDetailUnlckedDetail.add(liveStream);
                liveListDetailAvailable = liveListDetailUnlckedDetail;
            } else {
                liveListDetail.add(liveStream);
                liveListDetailAvailable = liveListDetail;
            }
            if (liveListDetailAvailable != null && viewpager != null && slidingTabs != null) {
                viewpager.setAdapter(new LiveStreamsEPGCategoriesAdapter(liveListDetailAvailable, getSupportFragmentManager(),
                        LiveStreamEpgAcitivity.this));
                ...
                viewpager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
                    ...
                    public void onPageSelected(int i) {
                        ...
                        int position = i;
                        NewEPGFragment fragment = ((LiveStreamsEPGCategoriesAdapter) viewpager.getAdapter()).getFragment(i);
                        if (i == 1) {
