...
public class LiveTVListViewCatActivity extends AppCompatActivity implements LiveStreamsInterface,
...
//    FrameLayout frameLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        if (!getActiveLiveStreamCategoryName.isEmpty())
            vodCategoryName.setText(getActiveLiveStreamCategoryName);
        setDrawerToggle();
...
//        vodAdapter = new LiveStreamsAdapter(favouriteStreams, getContext());
        ...
        if (context != null) {
            ...
            if (myRecyclerView != null && favouriteStreams != null && favouriteStreams.size() != 0) {
                ...
                liveStreamsAdapter = new LiveStreamsAdapter(favouriteStreams, context);
                myRecyclerView.setAdapter(liveStreamsAdapter);
    ...
    private void setUpdatabaseResult() {
        ...
        if (context != null) {
            ...
            liveListDetailAvailableNew = new ArrayList<LiveStreamsDBModel>();
            ...
            if (getActiveLiveStreamCategoryId.equals("-1")) {
                ...
                if (liveListDetailAvailable != null && myRecyclerView != null && liveListDetailAvailable.size() != 0) {
                    ...
                    liveStreamsAdapter = new LiveStreamsAdapter(liveListDetailAvailable,context);
                    myRecyclerView.setAdapter(liveStreamsAdapter);
                    liveStreamsAdapter.notifyDataSetChanged();
                } else {
                    if (tvNoStream != null) {
...
//                AlertDialog.Builder alertDialog = new AlertDialog.Builder(LiveTVListViewCatActivity.this);
...
//                AlertDialog.Builder alertDialog1 = new AlertDialog.Builder(LiveTVListViewCatActivity.this);
//                // Setting Dialog Title
//                alertDialog1.setTitle("Confirm to Refreshing...");
//                // Setting Dialog Message
//                alertDialog1.setMessage("Do you want to proceed ?");
//                // Setting Icon to Dialog
