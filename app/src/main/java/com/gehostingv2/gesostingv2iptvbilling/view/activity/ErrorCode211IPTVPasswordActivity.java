...
import com.gehostingv2.gesostingv2iptvbilling.view.fragment.ErrorCode211IPTVPasswordFragment;
...
public class ErrorCode211IPTVPasswordActivity extends AppCompatActivity implements ClientDetailInterface,
        ...
        ErrorCode211IPTVPasswordFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_error_code211_iptvpassword);
...
// finally change the color
    ...
    private Fragment getHomeFragment() {
        ErrorCode211IPTVPasswordFragment errorCode211IPTVUserNameFragment = new ErrorCode211IPTVPasswordFragment();
        return errorCode211IPTVUserNameFragment;
    }
...
//                selectedItem = TAG_MY_SERVICES;
        ...
        Runnable mPendingRunnable = new Runnable() {
            ...
            public void run() {
                ...
                fragmentTransaction.replace(R.id.frame, fragment, AppConst.TAG_ERROR_CODE_211_PASSWORD_EMPTY);
