...
import com.gehostingv2.gesostingv2iptvbilling.view.adapter.LiveAdapterNewFlow;
...
import com.gehostingv2.gesostingv2iptvbilling.view.fragment.ErrorCode210IPTVUserNameFragment;
...
import com.gehostingv2.gesostingv2iptvbilling.view.fragment.NoServicePurchasedFragment;
...
public class LiveTVListViewActivity extends AppCompatActivity implements LiveStreamsInterface,
        ...
        NoServicePurchasedFragment.OnFragmentInteractionListener,
        ErrorCode210IPTVUserNameFragment.OnFragmentInteractionListener {
...
//    AppBarLayout appbarToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((getResources().getConfiguration().screenLayout &
            ...
            if (viewpager != null) {
                viewpager.setBackground(getResources().getDrawable(R.drawable.layout_background_tv));
            }
        } else {
            if (viewpager != null) {
                viewpager.setBackground(getResources().getDrawable(R.drawable.layout_background));
            }
        }
...
//        initialize();
    ...
    private void setUpDatabaseResults() {
        if (context != null) {
            ...
            liveListDetail = liveStreamDBHandler.getAllliveCategories();
            ArrayList<LiveStreamCategoryIdDBModel> liveListDetail = liveStreamDBHandler.getAllliveCategories();
            ...
            if (parentalStatusCount > 0 && liveListDetail != null) {
                ...
                liveListDetailUnlckedDetail = getUnlockedCategories(liveListDetail,
                        listPassword);
            ...
            adapter = new LiveAdapterNewFlow(liveListDetailAvailable, context);
            if ((getResources().getConfiguration().screenLayout &
                    Configuration.SCREENLAYOUT_SIZE_MASK) ==
                    Configuration.SCREENLAYOUT_SIZE_LARGE) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
                        ...
                        if (adapter != null) {
                            if (tvNoStream != null) {
                                if (tvNoStream.getVisibility() != View.VISIBLE) {
                                    adapter.filter(newText, tvNoRecordFound);
                                }
                            }
                        }
                        return false;
            ...
            case R.id.menu_load_channels_vod1:
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(LiveTVListViewActivity.this);
            ...
            case R.id.menu_load_tv_guide1:
                AlertDialog.Builder alertDialog1 = new AlertDialog.Builder(LiveTVListViewActivity.this);
                // Setting Dialog Title
...
// finally change the color
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            adapter.setVisibiltygone(pbPagingLoader1);
            super.onBackPressed();
            //moveTaskToBack(true);
        }
    }
...
//            Intent liveStreamsIntent = new Intent(this, LiveTVTabViewActivity.class);
//            this.startActivity(liveStreamsIntent);
//        } else if (id == R.id.nav_favourites) {
//            Intent favouritesIntent = new Intent(this, FavouritesActivity.class);
//            startActivity(favouritesIntent);
//        } else if (id == R.id.nav_vod) {
//            Intent vodIntent = new Intent(this, VodTabViewActivity.class);
...
//        }
    ...
    @Override
    public void liveStreamCategories(List<LiveStreamCategoriesCallback> liveStreamCategories) {

        LiveStreamCategoriesCallback liveStream = new LiveStreamCategoriesCallback();
        LiveStreamCategoriesCallback liveStream1 = new LiveStreamCategoriesCallback();
        liveStream.setCategoryId("0");
        liveStream.setCategoryName("ALL");
        liveStream.setParentId(0);

        liveStream1.setCategoryId("-1");
        liveStream1.setCategoryName("Favourites");
        liveStream1.setParentId(0);

        liveStreamCategories.add(0, liveStream);
        liveStreamCategories.add(1, liveStream1);
//        if (liveStreamCategories != null && viewpager != null && slidingTabs != null) {
//            viewpager.setAdapter(new LiveStreamCategoriesAdapter(liveStreamCategories, getSupportFragmentManager(),
//                    LiveTVTabViewActivity.this));
...
//                    int position = i;
//                    LiveStreamsFragment fragment = ((LiveStreamCategoriesAdapter) viewpager.getAdapter()).getFragment(i);
//                    if (i == 1) {
//                        fragment.getFavourites();
//                    }
//                }
//
//                @Override
...
//                    editor1.putString(AppConst.LOGIN_PREF_ALLOWED_FORMAT, allowedFormat);
                    ...
                    editor1.commit();
                } else if (auth == 1 && !userStatus.equals("Active")) {
