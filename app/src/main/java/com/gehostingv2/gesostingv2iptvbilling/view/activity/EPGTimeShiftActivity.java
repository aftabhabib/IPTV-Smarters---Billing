...
public class EPGTimeShiftActivity extends AppCompatActivity implements ClientDetailInterface,
...
//                loadFragment(selectedItem);
    ...
    private void callSettings() {
        ...
        int epgPosition = Utils.getPositionOfEPG(savedEPGShift);
        spinnerEPG.setSelection(epgPosition);
    }
...
//        Toast.makeText(this,
//                "OnClickListener : " +
//                        "\nSpinner 1 : "+ String.valueOf(spinnerEPG.getSelectedItem()), Toast.LENGTH_SHORT).show();
        switch (view.getId()) {
            case R.id.bt_save_changes:
                loginPrefsEditor = loginPreferencesAfterLogin.edit();
                if (loginPrefsEditor != null) {
                    spinnerEPG.getSelectedItemPosition();
                    loginPrefsEditor.putString(AppConst.LOGIN_PREF_SELECTED_EPG_SHIFT, String.valueOf(spinnerEPG.getSelectedItem()));
                    loginPrefsEditor.commit();
                    Toast.makeText(EPGTimeShiftActivity.this, getResources().getString(R.string.player_setting_save), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(EPGTimeShiftActivity.this, getResources().getString(R.string.player_setting_error), Toast.LENGTH_SHORT).show();
                }
                break;
