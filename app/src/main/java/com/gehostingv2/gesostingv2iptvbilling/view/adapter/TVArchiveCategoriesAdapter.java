...
import com.gehostingv2.gesostingv2iptvbilling.view.fragment.TVArchiveFragment;
...
public class TVArchiveCategoriesAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        return  TVArchiveFragment.newInstance(LiveStreamCategoriesIds[position]);
    }
    ...
    public TVArchiveFragment getFragment(int position){
        ...
        if(tag == null)
            return null;
        return (TVArchiveFragment) mFragmentManager.findFragmentByTag(tag);
    }
