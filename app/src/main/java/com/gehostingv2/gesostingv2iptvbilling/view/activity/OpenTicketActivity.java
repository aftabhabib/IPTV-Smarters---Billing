...
public class OpenTicketActivity extends AppCompatActivity implements ClientDetailInterface,
...
//                setupDrawerContent(navView);
        ...
        } else if (clientNanmeTv != null && username != null && !username.isEmpty()) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            OpenTicketActivity activity = this;
...
//    }
    ...
    private Fragment getHomeFragment() {
        OpenTicketGeneralEnquiriesDepartmentFragment servicesFragment = new OpenTicketGeneralEnquiriesDepartmentFragment();
    ...
    private void setupDrawerContent(NavigationView navigationView) {
        ...
        if (intent != null) {
            ...
            loginCheck = intent.getStringExtra("LoginCheck");
...
//                selectedItem = TAG_MY_SERVICES;
            ...
            } else if (loginCheck != null && loginCheck.equals("openTicket")) {


                Fragment mFragment = null;
                mFragment = new OpenTicketGeneralEnquiriesDepartmentFragment();
                FragmentManager fragmentManager1 = getSupportFragmentManager();
                fragmentManager1.beginTransaction()
                        .replace(R.id.frame, mFragment).commit();
...
//        billingList.add("MY CREDITS");
    ...
    private void homeFragmentToLoad() {
        if (getSupportFragmentManager().findFragmentByTag(AppConst.TAG_OPEN_TICKET_GEN_ENQ) != null) {
            getSupportFragmentManager().popBackStackImmediate(AppConst.TAG_OPEN_TICKET_GEN_ENQ,
