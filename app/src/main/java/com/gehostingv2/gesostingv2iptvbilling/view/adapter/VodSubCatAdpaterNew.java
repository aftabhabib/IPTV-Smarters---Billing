...
import com.gehostingv2.gesostingv2iptvbilling.view.activity.VoDListViewSubCatActivity;
...
public class VodSubCatAdpaterNew extends RecyclerView.Adapter<VodSubCatAdpaterNew.MyViewHolder> {
    ...
    public VodSubCatAdpaterNew(List<LiveStreamCategoryIdDBModel> movieList,
                               Context context,
    ...
    @Override
    public VodSubCatAdpaterNew.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                               int viewType) {
        View view;
        view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_vod_new_flow_list_item, parent, false);
        VodSubCatAdpaterNew.MyViewHolder myViewHolder = new VodSubCatAdpaterNew.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(final VodSubCatAdpaterNew.MyViewHolder holder, final int listPosition) {
        String categoryName = "";
        String categoryId = "";
...
//        liveStreamDBHandler.getAllLiveStreasWithCategoryId(data.getLiveStreamCategoryID(), "movie");
...
//                vodActivityNewFlow.progressBar(holder.pbPagingLoader);
                VoDListViewSubCatActivity voDCategoryActivity = new VoDListViewSubCatActivity();
                voDCategoryActivity.progressBar(holder.pbPagingLoader);
                ...
                Intent intent = new Intent(context, VoDListViewSubCatActivity.class);
