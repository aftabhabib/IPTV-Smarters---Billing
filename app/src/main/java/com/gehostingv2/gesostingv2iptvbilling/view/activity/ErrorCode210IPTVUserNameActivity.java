...
public class ErrorCode210IPTVUserNameActivity extends AppCompatActivity implements ClientDetailInterface,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_error_code210_iptvuser_name);
...
// finally change the color
    ...
    private Fragment getHomeFragment() {
        ErrorCode210IPTVUserNameFragment errorCode210IPTVUserNameFragment = new ErrorCode210IPTVUserNameFragment();
        return errorCode210IPTVUserNameFragment;
    }
...
//                selectedItem = TAG_MY_SERVICES;
        ...
        Runnable mPendingRunnable = new Runnable() {
            ...
            public void run() {
                ...
                fragmentTransaction.replace(R.id.frame, fragment, AppConst.TAG_ERROR_CODE_210_USERNAME_EMPTY);
