...
public class EPGChannelUpdateActivity extends AppCompatActivity implements LoginIPTVInterface,
...
//                setupDrawerContent(navView);
    ...
    private void setValues() {
        ...
        loginPreferencesAfterLogin = getSharedPreferences(AppConst.LOGIN_PREF_EPG_CHANNEL_UPDATE, MODE_PRIVATE);
        String channelupdate = loginPreferencesAfterLogin.getString(AppConst.LOGIN_PREF_EPG_CHANNEL_UPDATE, "");
        if(channelupdate.equals("all")){
            rballchannels.setChecked(true);
        }else{
            rbwithepg.setChecked(true);
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            EPGChannelUpdateActivity activity = this;
            ...
            case R.id.bt_save_changes:
                ...
                if (loginPrefsEditor != null) {
                    if(selectedPlayer.getText().toString().equals(getResources().getString(R.string.all_channel))){
                        loginPrefsEditor.putString(AppConst.LOGIN_PREF_EPG_CHANNEL_UPDATE, "all");
                    }else{
                        loginPrefsEditor.putString(AppConst.LOGIN_PREF_EPG_CHANNEL_UPDATE, "withepg");
                    }
                    loginPrefsEditor.commit();
                    Toast.makeText(EPGChannelUpdateActivity.this, getResources().getString(R.string.player_setting_save), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(EPGChannelUpdateActivity.this, getResources().getString(R.string.player_setting_error), Toast.LENGTH_SHORT).show();
                }
