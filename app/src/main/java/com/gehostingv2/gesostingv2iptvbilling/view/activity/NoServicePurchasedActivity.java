...
public class NoServicePurchasedActivity extends AppCompatActivity implements ClientDetailInterface,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_no_service_purchased);
...
//                setupDrawerContent(navView);
        ...
        } else if (username != null && !username.isEmpty() && clientNanmeTv != null) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            NoServicePurchasedActivity activity = this;
...
// finally change the color
    ...
    private Fragment getHomeFragment() {
        NoServicePurchasedFragment servicesFragment = new NoServicePurchasedFragment();
...
//                selectedItem = TAG_MY_SERVICES;
        ...
        Runnable mPendingRunnable = new Runnable() {
            ...
            public void run() {
                ...
                fragmentTransaction.replace(R.id.frame, fragment, AppConst.TAG_NO_SERVICE_PURCHASED);
