...
public class AuthorizationIssueActivity extends AppCompatActivity implements ClientDetailInterface,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_authorization_issue);
...
//                setupDrawerContent(navView);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            AuthorizationIssueActivity activity = this;
...
// finally change the color
    ...
    private Fragment getHomeFragment() {
        AuthorizationIssueFragment servicesFragment = new AuthorizationIssueFragment();
