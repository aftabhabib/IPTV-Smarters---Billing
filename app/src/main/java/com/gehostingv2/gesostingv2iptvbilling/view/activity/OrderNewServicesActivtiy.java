...
import com.gehostingv2.gesostingv2iptvbilling.view.fragment.OrderNewServicesFragment;
...
public class OrderNewServicesActivtiy extends AppCompatActivity implements ClientDetailInterface,
        ...
        OrderNewServicesFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_new_services_activtiy);
...
//                setupDrawerContent(navView);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            OrderNewServicesActivtiy activity = this;
...
// finally change the color
    ...
    private Fragment getHomeFragment() {
        OrderNewServicesFragment servicesFragment = new OrderNewServicesFragment();
