...
public class InvoicesActivity extends AppCompatActivity implements ClientDetailInterface,
        ...
        InvoiceViewFragment.OnFragmentInteractionListener {
...
//                setupDrawerContent(navView);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            InvoicesActivity activity = this;
...
//    }
    ...
    private Fragment getHomeFragment() {
        InvoicesFragment servicesFragment = new InvoicesFragment();
...
//        billingList.add("MY CREDITS");
    ...
    private void homeFragmentToLoad() {
        ...
        if (getSupportFragmentManager().findFragmentByTag(AppConst.TAG_GET_INVOICE_DETIAIL) != null) {
            getSupportFragmentManager().popBackStackImmediate(AppConst.TAG_GET_INVOICE_DETIAIL,
