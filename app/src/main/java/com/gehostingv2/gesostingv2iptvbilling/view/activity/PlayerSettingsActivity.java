...
public class PlayerSettingsActivity extends AppCompatActivity implements ClientDetailInterface,
...
//                setupDrawerContent(navView);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            PlayerSettingsActivity activity = this;
...
//                loadFragment(selectedItem);
    ...
    private void callSettings() {
        ...
        } else if (savedSelectedPlayer.equals(getResources().getString(R.string.vlc_player))) {
            ...
            case R.id.bt_save_changes:
                ...
                if (settingsPrefs != null) {
                    ...
                    if (settingsPrefsEditor != null) {
                        ...
                        Toast.makeText(PlayerSettingsActivity.this, context.getResources().getString(R.string.setting_save), Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(PlayerSettingsActivity.this, context.getResources().getString(R.string.error_setting_save), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(PlayerSettingsActivity.this, context.getResources().getString(R.string.error_setting_save), Toast.LENGTH_SHORT).show();
                }
