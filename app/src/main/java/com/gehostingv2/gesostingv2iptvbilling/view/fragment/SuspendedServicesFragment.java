 ...
 * {@link SuspendedServicesFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SuspendedServicesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SuspendedServicesFragment extends Fragment implements ServicesInterface {
    ...
    public SuspendedServicesFragment() {
     ...
     * @return A new instance of fragment SuspendedServicesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SuspendedServicesFragment newInstance(String param1, String param2) {
        SuspendedServicesFragment fragment = new SuspendedServicesFragment();
    ...
    public void getMyServices(GetClientProductsCallback getClientProductsCallback) {
        if (getClientProductsCallback != null) {
            ...
            ArrayList<ProductDetailPojo> suspendedServiceArrayList = new ArrayList<ProductDetailPojo>();
            for (ProductDetailPojo productDetailPojo : productDeailArrayList) {
                String status = productDetailPojo.getStatus();
                if (status.equals("Suspended"))
                    suspendedServiceArrayList.add(productDetailPojo);
            }
            if (suspendedServiceArrayList.size() > 0) {
                myRecyclerView.setVisibility(View.VISIBLE);
                emptyView.setVisibility(View.GONE);
                mAdapter = new ServicesAdapter(suspendedServiceArrayList, getContext(), dashboardActivity);
                myRecyclerView.setAdapter(mAdapter);
            } else if (suspendedServiceArrayList.isEmpty()) {
                if (myRecyclerView != null && emptyView != null) {
                    myRecyclerView.setVisibility(View.GONE);
                    emptyView.setVisibility(View.VISIBLE);
                    if (context != null)
                        emptyView.setText(context.getResources().getString(R.string.no_suspended_services));
                }
            }
        }
    }
