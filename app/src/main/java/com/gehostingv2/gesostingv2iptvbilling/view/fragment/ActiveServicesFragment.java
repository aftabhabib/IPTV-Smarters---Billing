 ...
 * Use the {@link ActiveServicesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ActiveServicesFragment extends Fragment implements ServicesInterface {
...
//    private DashboardActivity dashboardActivity;
     ...
     * @return A new instance of fragment ActiveServicesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ActiveServicesFragment newInstance(String param1, String param2) {
    ...
    public void getMyServices(GetClientProductsCallback getClientProductsCallback) {
        if (getClientProductsCallback != null) {
            ...
            ArrayList<ProductDetailPojo> activeServiceArrayList = new ArrayList<ProductDetailPojo>();
            for (ProductDetailPojo productDetailPojo : productDeailArrayList) {
                String status = productDetailPojo.getStatus();
                if (status.equals("Active"))
                    activeServiceArrayList.add(productDetailPojo);
            }
            if (activeServiceArrayList.size() > 0) {
                if (myRecyclerView != null && emptyView != null) {
                    myRecyclerView.setVisibility(View.VISIBLE);
                    emptyView.setVisibility(View.GONE);
                    mAdapter = new ServicesAdapter(activeServiceArrayList, getContext(), dashboardActivity);
                    myRecyclerView.setAdapter(mAdapter);
                }
            } else if (activeServiceArrayList.isEmpty()) {
                if (myRecyclerView != null && emptyView != null) {
                    myRecyclerView.setVisibility(View.GONE);
                    emptyView.setVisibility(View.VISIBLE);
                    if(context!=null)
                    emptyView.setText(context.getResources().getString(R.string.no_active_services));
                }
            }
        }
    }
