...
import com.gehostingv2.gesostingv2iptvbilling.view.adapter.TVArchiveCategoriesAdapter;
...
public class TVArchiveActivity extends AppCompatActivity implements LoginIPTVInterface,
...
//            liveStream2.setLiveStreamCategoryID("-2");
//            liveStream2.setLiveStreamCategoryName(getResources().getString(R.string.uncategories));
...
//                liveListDetailUnlcked.add(liveListDetailUnlcked.size(), liveStream2);
...
//                liveListDetail.add(liveListDetail.size(), liveStream2);

                liveListDetailAvailable = liveListDetail;
            }
            if (liveListDetailAvailable != null && viewpager != null && slidingTabs != null) {
                viewpager.setAdapter(new TVArchiveCategoriesAdapter(liveListDetailAvailable, getSupportFragmentManager(),
                        TVArchiveActivity.this));
...
//                        int position = i;
//                        if(viewpager!=null) {
//                            LiveStreamsFragment fragment = ((TVArchiveCategoriesAdapter) viewpager.getAdapter()).getFragment(i);
//                            if (i == 1) {
//                                if(fragment!=null) {
...
//        String expDate = loginPreferencesAfterLogin.getString(AppConst.LOGIN_PREF_EXP_DATE, "");
//        String isTrial = loginPreferencesAfterLogin.getString(AppConst.LOGIN_PREF_IS_TRIAL, "");
//        String activeCons = loginPreferencesAfterLogin.getString(AppConst.LOGIN_PREF_ACTIVE_CONS, "");
//        String createdAt = loginPreferencesAfterLogin.getString(AppConst.LOGIN_PREF_CREATE_AT, "");
//        String maxConnections = loginPreferencesAfterLogin.getString(AppConst.LOGIN_PREF_MAX_CONNECTIONS, "");
...
//            setValues(username, expDate, isTrial, activeCons, createdAt, maxConnections);
//        } else if (username.equals("") && username != null && username.isEmpty() &&
//                password.equals("") && password != null && password.isEmpty()) {
//        }
//    }

//    private void setValues(String username, String expDate, String isTrial,
//                           String activeCons, String createdAt, String maxConnections) {
//        if (tvUsername != null) {
//            if (!username.isEmpty()) {
//                cvAccountInfo.setVisibility(View.VISIBLE);
...
//            if (!expDate.isEmpty()) {
//                int expirySeconds = Integer.parseInt(expDate);
//                SimpleDateFormat formatter = new SimpleDateFormat("MMMM d, yyyy");
//                String expDateString = formatter.format(new Date(expirySeconds * 1000L));
//                tvExpiryDate.setText(expDateString);
//            } else {
//                tvExpiryDate.setText("Unlimited");
//            }
//        }
//        if (tvIsTrial != null) {
//            if (!isTrial.isEmpty()) {
...
//                tvActiveConn.setText(activeCons);
//            } else {
//                tvActiveConn.setText("--");
//            }
//        }
//        if (tvCreatedAt != null) {
//            if (!createdAt.isEmpty()) {
//                int createdAtSeconds = Integer.parseInt(createdAt);
//                SimpleDateFormat formatter = new SimpleDateFormat("MMMM d, yyyy");
//                String createdAtDateString = formatter.format(new Date(createdAtSeconds * 1000L));
//                tvCreatedAt.setText(createdAtDateString);
//            } else {
//                tvCreatedAt.setText("--");
//            }
//        }
//        if (tvMaxConnections != null) {
//            if (!maxConnections.isEmpty()) {
//                tvMaxConnections.setText(maxConnections);
//            } else {
//                tvMaxConnections.setText("--");
//            }
//        }
//    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            TVArchiveActivity activity = this;
