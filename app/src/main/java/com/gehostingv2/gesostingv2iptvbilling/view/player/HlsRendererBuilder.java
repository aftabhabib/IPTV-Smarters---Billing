//package com.dream.dreamxbmc.view.player;
//
...
// */
//public class HlsRendererBuilder implements StreamingPlayer.RendererBuilder {
//
...
//
//  @Override
//  public void buildRenderers(StreamingPlayer player) {
...
//
//    public AsyncRendererBuilder(Context context, String userAgent, String url, StreamingPlayer player) {
//      this.context = context;
//      this.userAgent = userAgent;
//      this.player = player;
...
//          MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, StreamingPlayer.TYPE_VIDEO);
...
//            TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, StreamingPlayer.TYPE_TEXT);
//        textRenderer = new TextTrackRenderer(textSampleSource, player, mainHandler.getLooper());
//      } else {
//        textRenderer = new Eia608TrackRenderer(sampleSource, player, mainHandler.getLooper());
//      }
//
//      TrackRenderer[] renderers = new TrackRenderer[StreamingPlayer.RENDERER_COUNT];
//      renderers[StreamingPlayer.TYPE_VIDEO] = videoRenderer;
//      renderers[StreamingPlayer.TYPE_AUDIO] = audioRenderer;
//      renderers[StreamingPlayer.TYPE_METADATA] = id3Renderer;
//      renderers[StreamingPlayer.TYPE_TEXT] = textRenderer;
