...
public class TicketsActivity extends AppCompatActivity implements ClientDetailInterface,
...
//    }
    ...
    private Fragment getHomeFragment() {
        ...
        String ticketId = "";
        if (intent != null)
            ticketId = intent.getStringExtra(AppConst.TICKET_ID);
        if (ticketId != null && !ticketId.isEmpty()) {
            Bundle bundle = new Bundle();
            bundle.putInt(AppConst.TICKET_ID, Integer.parseInt(ticketId));
            ...
            TicketsFragment servicesFragment = new TicketsFragment();
...
//                loadFragment(selectedItem);
    ...
    private void replyTicketFragment() {
        String menuFragment = getIntent().getStringExtra("message");
...
//        billingList.add("MY CREDITS");
    ...
    private void homeFragmentToLoad() {
        if (getSupportFragmentManager().findFragmentByTag(AppConst.TAG_VIEW_TICKET_REQUEST) != null) {
            getSupportFragmentManager().popBackStackImmediate(AppConst.TAG_VIEW_TICKET_REQUEST,
