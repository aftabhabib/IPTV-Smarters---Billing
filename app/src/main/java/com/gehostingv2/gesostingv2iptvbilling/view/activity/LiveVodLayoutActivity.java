...
public class LiveVodLayoutActivity extends AppCompatActivity implements LoginIPTVInterface,
...
//                setupDrawerContent(navView);
    ...
    private void setValues() {
        ...
        loginPreferencesAfterLogin = getSharedPreferences(AppConst.LOGIN_PREF_LIVE_VOD_LAYOUT, MODE_PRIVATE);
        int layout_flag = loginPreferencesAfterLogin.getInt(AppConst.LOGIN_PREF_LIVE_VOD_LAYOUT, 0);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            LiveVodLayoutActivity activity = this;
...
//                    loginPrefsEditor.putString(AppConst.LOGIN_PREF_SELECTED_STREAM_FORMAT, selectedPlayer.getText().toString());
//                    loginPrefsEditor.commit();
//                    Toast.makeText(StreamFormatActivity.this, getResources().getString(R.string.player_setting_save), Toast.LENGTH_SHORT).show();
//                } else {
//                    Toast.makeText(StreamFormatActivity.this, getResources().getString(R.string.player_setting_error), Toast.LENGTH_SHORT).show();
//                }
                if (loginPrefsEditor != null) {
                    if (selectedPlayer.getText().toString().equals(getResources().getString(R.string.layout_style_tab))) {
                        loginPrefsEditor.putInt(AppConst.LOGIN_PREF_LIVE_VOD_LAYOUT, 1);
                    } else {
                        loginPrefsEditor.putInt(AppConst.LOGIN_PREF_LIVE_VOD_LAYOUT, 0);
                    }
                    loginPrefsEditor.commit();
                    Toast.makeText(LiveVodLayoutActivity.this, getResources().getString(R.string.player_setting_save), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(LiveVodLayoutActivity.this, getResources().getString(R.string.player_setting_error), Toast.LENGTH_SHORT).show();
                }
