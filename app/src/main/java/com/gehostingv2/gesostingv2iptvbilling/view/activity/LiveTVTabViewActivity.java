...
import com.gehostingv2.gesostingv2iptvbilling.view.adapter.LiveStreamCategoriesAdapter;
...
import com.gehostingv2.gesostingv2iptvbilling.view.fragment.LiveStreamsFragment;
...
public class LiveTVTabViewActivity extends AppCompatActivity
...
//        initialize();
    ...
    private void setUpDatabaseResults() {
        if(context!=null) {
            Toast.makeText(context,getResources().getString(R.string.use_long_press),Toast.LENGTH_LONG).show();
...
//            xmltvPresenter = new XMLTVPresenter(this, context);
            ...
            if (liveListDetailAvailable != null && viewpager != null && slidingTabs != null) {
                viewpager.setAdapter(new LiveStreamCategoriesAdapter(liveListDetailAvailable, getSupportFragmentManager(),
